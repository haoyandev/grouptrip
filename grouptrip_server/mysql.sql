...
'名古屋位于东京和京都之间，所以也被称作中京，中部地区则被称作中京圈。随着丰田等地区的汽车制造业的快速发展，名古屋的工业发展也被逐渐地带动了起来，成为全国知名的工业城市，以名古屋为首的中京圈逐渐成为中部地区商业发展的中心。', '名古屋城，热田神宫，名古屋电视台，名古屋城天守阁','http://localhost:3000/citypics/7-3.jpeg','http://localhost:3000/poster/p14.jpg'),
...
'札幌是个典型的北国城市，具有浓厚的北国风味。札幌每年都有以冰雪为主题的户外活动，这就是札幌雪祭的由来。雪祭的主会场设在大通公园，郊区的真驹被开辟为第二会场，专供儿童玩耍。', '白色恋人巧克力工厂，札幌电视台，北海道神宫，札幌钟楼','http://localhost:3000/citypics/3-1.jpeg','http://localhost:3000/poster/p16.jpg'),
