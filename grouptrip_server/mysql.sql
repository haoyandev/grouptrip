...
/** 插入数据 **/
/** 插入用户表数据 **/
INSERT INTO trip_user(uid, uname, upwd, phone, birthday, city, gender, age) VALUES
(1, 'dingding', md5('123456'), '13790091222', '1990-02-18', '上海', '1', 20),
(2, 'xiaohao', md5('123456'), '13790091223', '1995-06-23', '顺德', '1', 17),
(3, 'victoria', md5('123456'), '13790091224', '1998-09-03', '广州', '0', 29),
(4, '金曼', md5('123456'), '15857836078', '1993-07-03', '北京', '0', 34),
(5, '乌拉拉多', md5('123456'), '1832200078', '1978-02-18', '天津', '0', 18),
(6, '皮卡兰', md5('123456'), '13501019666', '2000-09-28', '长春', '0', 11),
(7, 'dongdong', md5('123456'), '13790091225', '2000-01-25', '北京', '-1', 22),
(8, '黄浩浩', md5('123456'), '13501019887', '2000-09-28', '佛山', '0', 25),
(9, '被遗忘小依依', md5('123456'), '13911219666', '2000-09-28', '香港', '0', 33),
(10, '王老板', md5('123456'), '13644449666', '2000-09-28', '香港', '0', 52);
...
(1, 'http://localhost:3000/group/bg1.png', 'http://localhost:3000/citypics/1-1.jpg'),
(1, 'http://localhost:3000/group/bg2.png', 'http://localhost:3000/citypics/1-2.jpg'),
(1, 'http://localhost:3000/group/bg3.png', 'http://localhost:3000/citypics/1-3.jpg'),
(2, 'http://localhost:3000/group/bg4.png', 'http://localhost:3000/citypics/1-1.jpg'),
(),
(),
(),
(),
