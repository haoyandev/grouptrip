...
(8, '黄浩浩', md5('123456'), '13501019887', '2000-09-28', '佛山', '0'),
(9, '被遗忘小依依', md5('123456'), '13911219666', '2000-09-28', '香港', '0'),
(10, '王老板', md5('123456'), '13644449666', '2000-09-28', '香港', '0');
...
(null, 10, 21);
/** 插入组团游表数据 **/
INSERT INTO trip_group(gid, uid, tid, cid, intr, begin_time, end_time, create_time, update_time) VALUES
# 同一主题不同城市 香港 台湾 东京
(1, 1, 1, 110100,
